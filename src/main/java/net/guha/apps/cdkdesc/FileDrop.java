 ...
 * event with a changed border. <p/> To use this class, construct a new <tt>FileDrop</tt> by passing it the target
 * component and a <tt>Listener</tt> to receive notification when file(s) have been dropped. Here is an example: <p/>
 * <code><pre>
 ...
 * </pre></code>
 * <p/> You can specify the border that will appear when files are being dragged by calling the constructor with a
 * <tt>javax.swing.border.Border</tt>. Only <tt>JComponent</tt>s will show any indication with a border. <p/> You can
 * turn on some debugging features by passing a <tt>PrintStream</tt> object (such as <tt>System.out</tt>) into the full
 * constructor. A <tt>null</tt> value will result in no extra debugging information being output. <p/> <p/> <p>I'm
 * releasing this code into the Public Domain. Enjoy. </p> <p><em>Original author: Robert Harder,
 * rharder@usa.net</em></p> <p>2007-09-12 Nathan Blomquist -- Linux (KDE/Gnome) support added.</p>
 *
...
/* ********  I N N E R   C L A S S  ******** */
     ...
     * {@link FileDropListener} when files are dropped onto a registered drop target. <p/> <p>I'm releasing this code
     * into the Public Domain. Enjoy.</p>
     *
     * @author Robert Harder
...
/* ********  I N N E R   C L A S S  ******** */
     ...
     *      ...
     * </code></pre>
     * Or if you need to know when the data was actually dropped, like when you're moving data out of a list, say, you
     * can use the {@link TransferableObject.Fetcher} inner class to return your object Just in Time. For example:
     * <pre><code>
     *      ...
     ...
     *      ...
     * </code></pre>
     * <p/> The {@link java.awt.datatransfer.DataFlavor} associated with {@link TransferableObject} has the
     * representation class <tt>net.iharder.dnd.TransferableObject.class</tt> and MIME type
     * <tt>application/x-net.iharder.dnd.TransferableObject</tt>. This data flavor is accessible via the static {@link
     * #DATA_FLAVOR} property. <p/> <p/> <p>I'm releasing this code into the Public Domain. Enjoy.</p>
     *
     * @author Robert Harder
     * @author rob@iharder.net
     * @version 1.2
